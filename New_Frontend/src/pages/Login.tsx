 ...
 * 
 * Provides user authentication interface matching the Bank of Anthos design.
 * Integrates with the authentication service for JWT-based login.
 */
...
const Login: React.FC = () => {
  ...
  // Load default credentials from environment (matching Flask frontend)
  useEffect(() => {
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          <div className="mx-auto h-12 w-auto flex items-center justify-center">
            <h1 className="text-3xl font-bold text-blue-600">Bank of Anthos</h1>
          </div>
